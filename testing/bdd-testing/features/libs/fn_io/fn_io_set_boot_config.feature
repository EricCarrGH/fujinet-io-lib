Feature: IO library test - fn_io_set_boot_config
  ...
  Scenario: execute _fn_io_set_boot_config
    Given fn-io application test setup
      ...
      And I add common src file "fn_io_set_boot_config.s"
      And I add file for compiling "features/test-setup/test-apps/test_fn_io_set_boot_config.s"
      And I add file for compiling "features/test-setup/stubs/bus-simple.s"
      And I create and load application
      And I write memory at $80 with $ff
      And I write memory at t_toggle with $0a
